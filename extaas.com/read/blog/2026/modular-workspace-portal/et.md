...
![Modulaarne Workspace ühendab klienditeekonna tööriistad](cover.png)
...
<div class="css _radius _padding grid gap _2" style="margin-block: 1.5rem;">
  <div class="flex _wrap _space gap _2"><span class="css _color">PÕHIIDEE</span><strong>Moodul ei ole lihtsalt menüüpunkt</strong></div>
