...
This period provided a solid understanding of:
...
The goals of the first project were to:
...
- Built the frontend architecture  
- Implemented a component-based structure  
- Developed the user interface according to business logic requirements  
...
- Node.js servers  
- Chrome extensions  
- Electron and Tauri applications (limited experience)  
